...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> transaksi : <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
         ...
         <p> produk total : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
         <p> total harga : <span>IDR <?php echo $fetch_orders['total_price']; ?>K </span> </p>
         <p> metoda pembayaran : <span><?php echo $fetch_orders['method']; ?></span> </p>
