...
<section class="shopping-cart">
    ...
    <div  class="box">
        ...
        <div class="price">IDR <?php echo $fetch_cart['price']; ?>K </div>
        ...
        <div class="sub-total"> sub-total : <span>IDR <?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>K </span> </div>
    </div>
    <?php
    ...
    <div class="cart-total">
        <p>grand total : <span>IDR <?php echo $grand_total; ?>K </span></p>
