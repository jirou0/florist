    ...
    <div class="flex">
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="ordersnew.php">Pesanan</a></li>
                <li><a href="#">Akun +</a>
                    <ul>
        ...
        <div class="account-box">
            ...
            <a href="edit_users.php?update=<?php echo $fetch_users['id']; ?>" onclick="return confirm('update this user?');" class="delete-btn" !important;>edit akun</a> 
        </div>
