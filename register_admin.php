...
if (isset($_POST['submit'])) {
    ...
    $user_type = 'user'; // Set the default value as 'user'
    ...
    if (mysqli_num_rows($select_admin) > 0) {
        ...
        if ($pass != $cpass) {
            ...
            if ($stmt) {
                mysqli_stmt_bind_param($stmt, "sssssssssss", $name, $birthplace, $email, $no_hp, $address, $pass, $question, $answer, $keahlian, $jabatan, $user_type);
