...
<section class="heading">
    <h3>Favoritku</h3>
    <p> <a href="home.php">home</a> / Favorit </p>
</section>

<section class="wishlist">

    <h1 class="title">Favoritku</h1>
    ...
    <form action="" method="POST" class="box">
        ...
        <div class="price">IDR <?php echo $fetch_wishlist['price']; ?>K </div>
    ...
    <div class="wishlist-total">
        <p>Total : <span>IDR <?php echo $grand_total; ?>K </span></p>
